...
! Ebru: Change the values for Mars!
...
! Ebru
  use constants, only: REFERENCE_MODEL_SOHL !, R_MARS
! Ebru_end

  use shared_parameters, only: &
    CASE_3D, REFERENCE_1D_MODEL !, CRUSTAL, HONOR_1D_SPHERICAL_MOHO, REFERENCE_1D_MODEL
...
if (REFERENCE_1D_MODEL == REFERENCE_MODEL_SOHL) then
  ...
  radius(7)  = R670   !     670
  radius(8)  = R771   !     771
  !radius(9)  = 1800000.0d0 ! 1650 - 2nd Mesh Doubling: Geochemical Layering;
  !Kellogg et al. 1999, Science
  !radius(9)  = 1550000.0d0 ! 1650 - 2nd Mesh Doubling: Geochemical Layering;
  !Kellogg et al. 1999, Science
  !!radius(9)  = 1650000.0d0  ! 1650 - 2nd Mesh Doubling: Geochemical Layering; Kellogg et al. 1999, Science
  radius(9)  = 2190000.0d0  ! 1200 - 2nd Mesh Doubling: Geochemical Layering; Kellogg et al. 1999, Science
  radius(10) = RTOPDDOUBLEPRIME   !     D''
  radius(11) = RCMB   !     CMB
  !!radius(12) = 1200000.0d0  !    3860 - 3rd Mesh Doubling Interface
  radius(12) = 1300000.0d0  !    2090 - 3rd Mesh Doubling Interface
  !radius(13) = 610000.0d0   !    5000 - 4th Mesh Doubling Interface
  radius(13) = 700000.0d0   !    2690 - 4th Mesh Doubling Interface
